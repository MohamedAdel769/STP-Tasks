class SmileyGame{
    ...
    constructor(Nfaces: number, difficulty: number, img: string) {
    ...
    checkResult(currID: string) : boolean{
        if(currID === "target"){
            alert("GG EZZZZZZ!");
            this.levelUp();
            return true;
...
function fillPanel(new_game: SmileyGame){
...
function addTarget(target_smile: HTMLElement){
